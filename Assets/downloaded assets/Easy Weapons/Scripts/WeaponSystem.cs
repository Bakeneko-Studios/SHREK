...
public class WeaponSystem : MonoBehaviour
{
	...
	public List<int> currentWeapons;
	...
	public void SetActiveWeapon(int index)
	{
		...
		if (index >= currentWeapons.Count || index < 0)
		{
		...
		weapons[currentWeapons[index]].SetActive(true);
	}

	public void NextWeapon()
	{
		weaponIndex++;
		if (weaponIndex > currentWeapons.Count - 1)
			weaponIndex = 0;
		SetActiveWeapon(weaponIndex);
	}
	...
	public void PreviousWeapon()
	{
		weaponIndex--;
		if (weaponIndex < 0)
			weaponIndex = currentWeapons.Count - 1;
		SetActiveWeapon(weaponIndex);
	}

	public void AddWeapon(int theWeapon)
    {
		currentWeapons.Add(theWeapon);
		weaponIndex = currentWeapons.Count - 1;
		SetActiveWeapon(weaponIndex);
	}
