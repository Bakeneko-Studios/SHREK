...
public class FirstPersonCharacter : MonoBehaviour
{
	...
	public GameObject weaponManage;
	...
	public void ChangeHealth(float amount)
	{
		...
		healthbar.transform.localScale = new Vector3((health/100),
	...
	{
		if (other.tag == "dangerous" || other.tag == "Enemy")
		{
			ChangeHealth(-0.1f);
		}
	}
	...
	{
		if (collision.collider.tag == "weaponDrop")
		{
			weaponManage.GetComponent<WeaponSystem>().AddWeapon(collision.collider.gameObject.GetComponent<weaponDropp>().weapon);
